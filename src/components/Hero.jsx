    ...
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute 
        inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
          ...
          <div>
            <h1 className={`${styles.heroHeadText} text-white`}>Hi,I'm <span className='text-[#915eff]'>Joyneel</span></h1>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              I am a student,<br className='sm:block hidden'/> a data analytics enthusiast
            </p>
          </div>
        ...
        <a href = "#about">
          ...
          border-4 border-secondary flex justify-center items-start p-2'>
            <motion.dev
              ...
              className='w-3 h-3 rounded-4 bg-secondary mb-1'
            />
          </div>
        </a>
      </div>
